            ...
            <?php foreach ($car as $c) { ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul>
                                <li>Merek Mobil : <?= $c['warna'] ?></li>
                                <li>Tahun Mobil : <?= $c['thn_mobil'] ?></li>
                                <li>Seater / Kapasitas Orang : <?= $c['jml_kursi'] ?></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <ul>
                                <li>Transmisi : <?= $c['transmisi'] ?></li>
                                <li>Jenis Ganjil / Genap TNKB Mobil : <?= $c['tnkb'] ?></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul>
                                <!-- masih manual -->
                                <li><strong>Rp.</strong> <?= $c['harga'] ?> / 24 Jam</li>
                            </ul>
                        </div>
                    </div>
                </div>

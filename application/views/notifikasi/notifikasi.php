        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Admin <span class="text-success">menyetujui</span> penyewaan</td>
                    <?php } ?>
                ...
                <tr>
                    <td colspan="7" class="text-center">Mohon segera melakukan pembayaran ke bank <strong class="font-weight-bold"><?= $bank['bank'] ?></strong> dengan nomor rekening <strong class="font-weight-bold"><?= $bank['norek'] ?></strong> dan mengirim bukti pembayaran sebesar Rp. <?= $s['harga'] * $s['hari'] ?></td>
                </tr>
                ...
                <?php if (!empty($s['pay_confirm_at'])) { ?>
                <tr>
                    <td colspan="7" class="text-center">Mohon untuk membawa <strong>KTP Asli</strong> sebagai jaminan penyewaan mobil</td>
                </tr>
                <tr>
                    <td colspan="7" class="text-center">Unduh <strong>Kwitansi</strong> dibawah ini. Untuk konfirmasi nantinya saat berada dilokasi penyewaan kepada admin</td>
                </tr>
                <tr>
                    <td colspan="7" class="text-center">
